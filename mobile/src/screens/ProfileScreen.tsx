...
const s = StyleSheet.create({
  ...
  avatarTextBig: { fontSize: 36, fontFamily: fonts.bold, color: WHITE },
  profileName: { fontSize: 24, fontFamily: fonts.bold, color: '#111' },
  profileEmail: { fontSize: 14, fontFamily: fonts.regular, color: '#666', marginTop: 4 },
  upiBadge: { backgroundColor: '#F0F5FA', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, marginTop: 14 },
  upiBadgeText: { color: PAYTM_BLUE, fontFamily: fonts.bold, fontSize: 13 },
  ...
  profileListText: { flex: 1, fontSize: 16, fontFamily: fonts.semiBold, color: '#111' },
  ...
  logoutTextReal: { color: '#FF4E4E', fontFamily: fonts.bold, fontSize: 16 },
});
