...
const s = StyleSheet.create({
  ...
  txInfoGlobal: { flex: 1 },
  txRecipientGlobal: { fontSize: 15, fontFamily: fonts.bold, color: '#111' },
  txMetaGlobal: { fontSize: 12, fontFamily: fonts.medium, color: '#666', marginTop: 2 },
  txTimeGlobal: { fontSize: 10, fontFamily: fonts.regular, color: '#AAA', marginTop: 4 },
  txAmountGlobal: { fontSize: 16, fontFamily: fonts.bold },
});
