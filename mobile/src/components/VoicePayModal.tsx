...
const s = StyleSheet.create({
  ...
  voiceTitle: { fontSize: 24, fontFamily: fonts.bold, color: '#111' },
  voiceSub: { fontSize: 14, color: SUCCESS_GREEN, fontFamily: fonts.bold, marginTop: 4, marginBottom: 30 },
  ...
  voiceHint: { fontSize: 15, color: '#555', fontFamily: fonts.medium, marginBottom: 30 },
  voiceClose: { backgroundColor: '#F0F5FA', width: '100%', borderRadius: 16, padding: 18, alignItems: 'center' },
  voiceCloseText: { fontFamily: fonts.bold, color: PAYTM_BLUE, fontSize: 14 },
});
